...
/*	printk("r%x##%d##%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x.%x\n",
			rx->id, len,
			rx->data[0], rx->data[1], rx->data[2], rx->data[3],
			rx->data[4], rx->data[5], rx->data[6], rx->data[7],
			rx->data[8], rx->data[9], rx->data[10], rx->data[11],
			rx->data[12], rx->data[13], rx->data[14], rx->data[15],
			rx->data[16], rx->data[17], rx->data[18], rx->data[19],
			rx->data[20], rx->data[21], rx->data[22], rx->data[23],
			rx->data[24], rx->data[25], rx->data[26], rx->data[27],
			rx->data[28], rx->data[29], rx->data[30], rx->data[31],
			rx->data[32], rx->data[33], rx->data[34], rx->data[35],
			 rx->data[36], rx->data[37], rx->data[38], rx->data[39],
			 rx->data[40], rx->data[41], rx->data[42], rx->data[43]);*/
...
{
	//printk("mcp25xxfd_can_rx_read_frames \n");
