cmd_arch/arm/mach-imx/spl_sd.cfg.cfgtmp := aarch64-linux-gnu-gcc -E -Wp,-MD,arch/arm/mach-imx/.spl_sd.cfg.cfgtmp.d  -nostdinc -isystem /usr/lib/gcc-cross/aarch64-linux-gnu/7/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__    -D__ARM__           -fno-pic  -mstrict-align  -ffunction-sections -fdata-sections -fno-common -ffixed-r9    -fno-common -ffixed-x18 -pipe -march=armv8-a -D__LINUX_ARM_ARCH__=8     -x c -o arch/arm/mach-imx/spl_sd.cfg.cfgtmp arch/arm/mach-imx/spl_sd.cfg

source_arch/arm/mach-imx/spl_sd.cfg.cfgtmp := arch/arm/mach-imx/spl_sd.cfg
