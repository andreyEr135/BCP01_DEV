cmd_spl/drivers/ddr/imx8m/helper.o := aarch64-linux-gnu-gcc -Wp,-MD,spl/drivers/ddr/imx8m/.helper.o.d  -nostdinc -isystem /usr/lib/gcc-cross/aarch64-linux-gnu/7/include -Iinclude   -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SPL_BUILD -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -fshort-wchar -Os -fno-stack-protector -fno-delete-null-pointer-checks -g -fstack-usage -Wno-format-nonliteral -Werror=date-time -ffunction-sections -fdata-sections -D__ARM__ -mstrict-align -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -fno-common -ffixed-x18 -pipe -march=armv8-a -D__LINUX_ARM_ARCH__=8    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(helper)"  -D"KBUILD_MODNAME=KBUILD_STR(helper)" -c -o spl/drivers/ddr/imx8m/helper.o drivers/ddr/imx8m/helper.c

source_spl/drivers/ddr/imx8m/helper.o := drivers/ddr/imx8m/helper.c

deps_spl/drivers/ddr/imx8m/helper.o := \
  include/common.h \
...
spl/drivers/ddr/imx8m/helper.o: $(deps_spl/drivers/ddr/imx8m/helper.o)
